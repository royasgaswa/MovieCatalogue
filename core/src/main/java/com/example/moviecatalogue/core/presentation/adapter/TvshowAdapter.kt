package com.example.moviecatalogue.core.presentation.adapter
...
import com.example.moviecatalogue.core.presentation.CastedContex
    ...
    class TvshowViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(tvshow: TvshowEntityPresentation) {
            with(itemView) {
                ...
                setOnClickListener {
                    val intent = Intent(context, Class.forName("com.example.moviecataloge.presentation.ui.detail.DetailTvshowActivity")).apply {
