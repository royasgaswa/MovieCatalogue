...
class MovieViewModelTest {
    private lateinit var movieViewModel: com.example.moviecatalogue.movie.MovieViewModel
    ...
    @Before
    fun setUp() {
        movieViewModel = com.example.moviecatalogue.movie.MovieViewModel(catalogueRepository)
    }
